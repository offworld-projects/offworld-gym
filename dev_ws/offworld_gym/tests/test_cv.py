...
from offworld_gym.utils.offworld_gym_utils import OffworldGymUtils
...
def test():
    ...
    dimage_data = OffworldGymUtils.process_depth_msg(dimage_msg)
    ...
    rgbimage_data = OffworldGymUtils.process_img_msg(rgbimage_msg)
