...
sudo apt install --allow-unauthenticated -y ros-melodic-grid-map ros-melodic-frontier-exploration \
                    ros-melodic-ros-controllers ros-melodic-rospack \
...
echo "source /opt/ros/melodic/setup.bash --extend" >> $OFFWORLD_GYM_ROOT/scripts/gymshell.sh
